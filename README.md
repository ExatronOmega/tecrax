...
Current source line: `tecrax==0.3.10a0`, depending on
`govengine==0.16.8`, `sclite-core==1.0.8`, and `rexecop==0.2.15a0`.
Latest published PyPI baseline: `tecrax==0.3.10a0`; it contains the coordinated
...
```bash
pip install "tecrax==0.3.10a0"
tecrax status
```

For an explicit cross-stack pin, `pip install "rexecop[tecrax]==0.2.15a0"`
...
`0.2.15a0`, GovEngine `0.16.8`, and SCLite `1.0.8`. It does not add a second
