...
- **Latest published PyPI package:** `tecrax==0.3.9a0`; it contains the current B2 profile vector
- **Dependencies:** `govengine==0.16.8`, `sclite-core==1.0.8`, `rexecop==0.2.14a0`
