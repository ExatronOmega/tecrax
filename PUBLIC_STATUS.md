...
- **Package version:** `0.3.7a0` (`0.3.7-alpha`) published alpha
- **Latest published PyPI package:** `tecrax==0.3.7a0`; it contains the current B2 profile vector
- **Dependencies:** `govengine>=0.16.2,<0.17`, `sclite-core>=1.0.6,<1.1`, `rexecop>=0.2.8a0,<0.3`
