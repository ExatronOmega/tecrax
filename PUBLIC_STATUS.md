...
- **Source package version:** `0.3.10a0` (`0.3.10-alpha`) alpha
- **Latest published PyPI package:** `tecrax==0.3.10a0`; it contains the current B2 profile vector
- **Dependencies:** `govengine==0.16.8`, `sclite-core==1.0.8`, `rexecop==0.2.15a0`
