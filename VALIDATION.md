...
Expected result for source package `0.3.16a0`:

- `pyproject.toml`, `tecrax.__version__`, README, public status, and validators agree on `0.3.16a0` / `0.3.16-alpha`;
- latest PyPI publication is `0.3.16a0`, including the coordinated B2 profile vector;
- dependency truth is `govengine==0.16.9`, `sclite-core==1.0.8`, and `rexecop==0.2.21a0`;
